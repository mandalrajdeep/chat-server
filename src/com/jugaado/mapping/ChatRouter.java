...
public class ChatRouter {
	...
	public static void sendMessage(String user, String message) throws XMPPException {
		if(manager == null) {
			manager = MainApp.getXmppManager();
		}
	...
	public static void sendMessageFrom(String from, String to, String message) throws XMPPException {
