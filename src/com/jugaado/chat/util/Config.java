...
public class Config {
    ...
    public static final boolean AUTO_REPLY_ON = Boolean
        .valueOf(getProperty("autoReplyOn"));
    ...
    public static final String AUTOMATED_REPLY_QUERY_PATH =
            getProperty("automatedReplyCallPath");
    public static final String AUTOMATED_RESPONSE_FILE =
            getProperty("automatedResponseFile");
