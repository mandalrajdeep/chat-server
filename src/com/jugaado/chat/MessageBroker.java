...
public class MessageBroker {
	private static Queue<JMessage> incomingQueue = new ConcurrentLinkedQueue<JMessage>();
	private static Queue<JMessage> processedQueue = new ConcurrentLinkedQueue<JMessage>();
	private static Queue<Message> outgoingQueue = new ConcurrentLinkedQueue<Message>();
